...
```bash
User@DESKTOP-System-Product-Name:~/Desktop/confupr$ ./6.sh .
...
```bash
User@DESKTOP-AT7C2D2 MINGW64 ~/desktop ./tar.sh "test" "py"
...
```
```bash
User@DESKTOP-System-Product-Name:~/Desktop/confupr$ ./6.sh test.c test_new.c
